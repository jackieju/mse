...
// <-  add by jackie
  ...
  private:
    ...
    void ClassDef();
    void ClassBody();
    void VaList(PTYPEDES type, cha* szFistName);
    void AaySize();
    void ConstExpession();
    void FunctionHeade();
    void FunctionBody();
    ...
    void WhileStatement();
    void LocalDeclaation();
    void Conditional();
    void AssignmentOpeato();
    void LogORExp();
    void LogANDExp();
    void InclORExp();
    void ExclORExp();
    ...
    void UnayOpeato();
    void Pimay();
    void FunctionCall(FUNCCALL* pFuncEnty);
    void HashItem();
    void SetItem();
    void SetItems();
    void SetDef();
    void Ceato();
    void ActualPaametes(FUNCCALL* pFuncEnty);
